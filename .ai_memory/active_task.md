...
6. [ ] Practice the Git workflow on real work: every future change lands on a `feature/*` branch → PR → squash merge to `main` (starting with the next phase).
