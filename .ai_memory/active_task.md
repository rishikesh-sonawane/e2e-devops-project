...
12. [x] Phase 14 — Security Hardening COMPLETE (`555f0a0`, pushed `feature/p14-security`): KMS, Secrets Manager (+secrets-backed creds), Cognito (real JWT flow), WAF v2, least-privilege IAM, CI gates (pip-audit/gitleaks/trivy), audit script, ADR-12, docs/security.md. Live-verified; `component-wise-architecture/` gitignored. **PR + squash-merge pending.**
...
- PR for `feature/p14-security` not yet opened/merged — squash-merge before starting Phase 15 (docs/source-control.md).
